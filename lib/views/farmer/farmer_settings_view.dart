...
class FarmerSettingsView extends StatefulWidget {
  const FarmerSettingsView({Key? key}) : super(key: key);

  @override
  State<FarmerSettingsView> createState() => _FarmerSettingsViewState();
}

class _FarmerSettingsViewState extends State<FarmerSettingsView> {
